...
const updateOrderHewiyeti = async (numero) => {
    ...
    if (!fetchDataInterval) {
        ...
        fetchDataInterval = setInterval(fetchData,  kafkaParams["intervalDuration"]);  // <<< Reinitiate the fetchData interval if it was cleared
    }
...
mongoose.connection.on('connected', () => {
    ...
    fetchDataInterval = setInterval(fetchData,  kafkaParams["intervalDuration"]);  // Fetch data every 5 seconds
});
